...
for item in restaurant2_menu:
    session.add(MenuItem(**item, restaurant = restaurant2))
session.commit()
...
restaurant3_menu = [
    ...
    dict(
        name="Gyoza",
        description= ("The most prominent differences between Japanese-style gyoza and Chinese-style jiaozi "
                      "are the rich garlic flavor, which is less noticeable in the Chinese version, "
...
for item in restaurant3_menu:
    session.add(MenuItem(**item, restaurant = restaurant3))
session.commit()
...
restaurant4_menu = [
    ...
    dict(
        ...
        description= ("Vegan goodness. Burrito filled with rice, garbanzo beans, curry sauce, "
...
for item in restaurant4_menu:
    session.add(MenuItem(**item, restaurant = restaurant4))
session.commit()
...
for item in restaurant5_menu:
    session.add(MenuItem(**item, restaurant = restaurant5))
session.commit()
...
for item in restaurant6_menu:
    session.add(MenuItem(**item, restaurant = restaurant6))
session.commit()
...
restaurant7_menu = [
    ...
    dict(
        ...
        description= ("Chicken marinated in yoghurt and seasoned with a spicy mix(chilli, tamarind among others) "
                      "and slow cooked in a cylindrical clay or metal oven which gets its heat from burning charcoal."),
        price="$8.95",
        course="Entree"
    ),
    dict(
...
for item in restaurant7_menu:
    session.add(MenuItem(**item, restaurant = restaurant7))
session.commit()
...
for item in restaurant8_menu:
    session.add(MenuItem(**item, restaurant = restaurant8))
session.commit()
...
for item in restaurant9_menu:
    session.add(MenuItem(**item, restaurant = restaurant9))
session.commit()

# ===============================================================
print ("[INFO] Added menu items!")
